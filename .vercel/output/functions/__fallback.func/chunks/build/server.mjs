import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineAsyncComponent, defineComponent, useSlots, h, Fragment, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, useSSRContext, createApp, reactive, toRaw, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, effectScope, watch, nextTick, mergeProps, getCurrentScope, toRef, toValue, onScopeDispose, isReadonly, isRef, isShallow, isReactive } from 'vue';
import { k as createError$1, y as klona, z as headSymbol, A as hasProtocol, B as isScriptProtocol, q as joinURL, w as withQuery, C as useHead$1, D as defuFn, E as sanitizeStatusCode, F as getContext, $ as $fetch$1, G as baseURL, H as defu, I as createHooks, J as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BsZp1Gt5.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-Dw9nC4BS.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        { name: "description", content: "Experience the new standard of financial foundation. Secure, fast, and built for the modern investor." },
        { name: "viewport", content: "width=device-width, initial-scale=1" },
        { name: "charset", content: "utf-8" },
        { property: "og:title", content: "Staco Finance - The Future of Modern Investing" },
        { property: "og:description", content: "Experience the new standard of financial foundation. Secure, fast, and built for the modern investor." },
        { property: "og:type", content: "website" },
        { property: "og:url", content: "https://staco.finance" },
        { property: "og:image", content: "/assets/dashboard.png" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: "Staco Finance" },
        { name: "twitter:description", content: "Experience the new standard of financial foundation." },
        { name: "twitter:image", content: "/assets/dashboard.png" },
        { name: "theme-color", content: "#1F2334" }
      ],
      link: [
      ...
      script: [
        {
          ...
          innerHTML: JSON.stringify({
            ...
            "@type": "WebApplication",
            name: "Staco Finance",
            description: "The Future of Modern Investing",
            url: "https://staco.finance",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="selection:bg-blue-500/30"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "selection:bg-blue-500/30" }, [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-hq1AOg7k.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BlX0oYjf.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-CNXfxm5H.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { useNuxtApp as a, useRuntimeConfig as b, createError as c, useRouter as d, entry_default as default, nuxtLinkDefaults as e, useAppConfig as f, asyncDataDefaults as g, injectHead as i, navigateTo as n, resolveRouteObject as r, useHead as u };
